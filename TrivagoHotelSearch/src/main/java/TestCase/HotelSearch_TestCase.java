...
public class HotelSearch_TestCase {
    ...
    public void setUp() throws IOException {
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\aksha\\Workspace\\HotelBooking\\Drivers\\chromedriver.exe");
        driver = new ChromeDriver();
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        FileReader reader = new FileReader("C:\\Users\\aksha\\Workspace\\HotelBooking\\Data.properties");
        data = new Properties();
        data.load(reader);
    }
